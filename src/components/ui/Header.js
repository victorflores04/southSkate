...
import logo from '../../assets/shooot.svg';
        ...
        <React.Fragment>
             <Tabs 
                ...
                {routes.map((route,index)=> (
                    ...
                    color="secondary" className={classes.button} onClick={()=>props.setValue(5)}>
                        Tiempo Estimado
                    </Button>
                    <Menu id="simple-menu" anchorEl={anchorEl} open={openMenu} onClose={handleClose} 
                    classes={{paper: classes.menu}} MenuListProps={{onMouseLeave: handleClose}} elevation={0} 
        ...
        <React.Fragment>
            <SwipeableDrawer disableBackdropTransition={!iOS} disableDiscovery={iOS} open={openDrawer}
             ...
             classes={{paper: classes.drawer}}>
                 ...
                 <List disablePadding>
                     {routes.map(route =>(
                         <ListItem divider key={`${route}${route.activeIndex}`} button component={Link} to={route.link} selected={props.value===route.activeIndex}
                     ...
                     component={Link} classes={{root: classes.drawerItemEstimate, selected: classes.drawerItemSelected}} 
