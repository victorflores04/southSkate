...
export default function LandingPage(props){
    ...
    const matchesEMaricielo = useMediaQuery(theme.breakpoints.down("xs"))
    ...
    return (
        <Grid container direction="column" className={classes.mainContainer} >
                ...
                <Grid container justify="flex-end" alignItems="center" direction="row">
                    <Grid sm item className={classes.heroTextContainer}>
                        <Typography variant="h2" align="center">
                            Arequipa South Coast Tecnology 
                            <br/> 
                            to the South 
                        </Typography>
                        <Grid container justify="center" className={classes.buttonContainer}>
                            <Grid item>
                                ...
                                variant="contained" onClick={()=>props.setValue(5)}>Free estimate</Button>
                            </Grid>
                            <Grid item>
            ...
            <Grid item>{/*----RevolutionBlock----*/}
                <Grid container style={{height : "80em", marginTop: "10em"}} alignItems="center" justify="center">
            ...
            <Grid item>{/*----InformationBlock----*/}
            <Grid container style={{height: "60em"}} alignItems="center" direction="row"
            className={classes.infoBackground}>
                <Grid item container 
                style={{ textAlign: matchesEMaricielo ? "center" : "inherit"}} 
                direction={matchesEMaricielo ? "column" : "row"}>
                <Grid item sm style={{ marginLeft:matchesEMaricielo ? 0: matchesMaricielo ? "2em" : "5em"}}>
                    <Grid container style={{marginBottom: matchesEMaricielo ? "10em" : 0}} direction="column">
                ...
                <Grid item sm style={{ marginRight: matchesEMaricielo ? 0: matchesMaricielo ? "2em" : "5em", textAlign: matchesEMaricielo ?  "center" :"right"}} >
