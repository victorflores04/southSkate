...
let mailOptions= {
    from:'Vialfoc development', 
}

exports.sendMail = functions.https.onRequest((request, response) => {
    cors(request, response, ()=>{
        const {name, email, phone, message}= request.query
        mailOptions={...mailOptions, to:"victor.flores@tecsup.edu.pe", 
        subject:"prueba número tres", 
        html:
        `
        ...
        transporter.sendMail(mailOptions, error => {
            if (error) {
                ...
                response.send("mensaje enviado bebecita brrrr")
            }
        });
        ...
        ...mailOptions,
        to: email, 
        subject: "Recibimos tu mensaje bby", 
        html:
        `
                    ...
                    <td align="center">
                      ...
                      >
                        <tr>
                          <td align="center">
                            <a
                              href="http://www.vialfocdevelopment.com/"
                              target="_blank"
                            >
                              <img
                                align="center"
                                src="https://i.imgur.com/GdAt6QC.jpg"
                                alt="VialFoc Development"
                                width="600"
                                height=""
